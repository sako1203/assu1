...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    axios.get("http://localhost:5000/api/rapport-medecin?role=service-at")
  ...
  useEffect(() => {
    ...
    const autoSaveTimer = setTimeout(async () => {
      try {
        ...
        await axios.post(
          `http://localhost:5000/api/tableaux/certificats/${victimeSelected._id}`,
          data,
  ...
  useEffect(() => {
    ...
    const autoSaveTimer = setTimeout(async () => {
      try {
        ...
        await axios.post(
          `http://localhost:5000/api/tableaux/quittances/${victimeSelected._id}`,
          data,
          { headers: { "Content-Type": "application/json" } }
        );
  ...
  useEffect(() => {
    ...
    const autoSaveTimer = setTimeout(async () => {
      try {
        ...
        await axios.post(
          `http://localhost:5000/api/tableaux/reglements/${victimeSelected._id}`,
          data,
          { headers: { "Content-Type": "application/json" } }
        );
      ...
      try {
        ...
        await Promise.all(
          sectionsToSave.map(async (sectionKey) => {
            ...
            await axios.post(
              `http://localhost:5000/api/tableaux/backoffice/${victimeSelected._id}`,
              payload,
              { headers: { "Content-Type": "application/json" } }
            );
          })
  ...
  useEffect(() => {
    ...
    const autoSaveTimer = setTimeout(async () => {
      try {
        ...
        await axios.put(
          `http://localhost:5000/api/declaration-at/${victimeSelected._id}`,
          data,
          { headers: { "Content-Type": "application/json" } }
        );
  ...
  const chercherVictimes = async (societeId) => {
    ...
    if (societe) {
      res = await axios.get(
        "http://localhost:5000/api/dashboard/recherche",
        { params: { societe } }
      );
    } else {
  ...
  const saveVictimeData = async (victimeId, data) => {
    try {
      await axios.put(
        `http://localhost:5000/api/declaration-at/${victimeId}`,
        data,
        { headers: { "Content-Type": "application/json" } }
      );
  ...
  const saveCertificats = async (victimeId) => {
    try {
      ...
      await axios.post(
        `http://localhost:5000/api/tableaux/certificats/${victimeId}`,
        data,
        { headers: { "Content-Type": "application/json" } }
      );
  ...
  const saveQuittances = async (victimeId) => {
    try {
      ...
      await axios.post(
        `http://localhost:5000/api/tableaux/quittances/${victimeId}`,
        data,
        { headers: { "Content-Type": "application/json" } }
      );
  ...
  const saveReglements = async (victimeId) => {
    try {
      ...
      await axios.post(
        `http://localhost:5000/api/tableaux/reglements/${victimeId}`,
        data,
        { headers: { "Content-Type": "application/json" } }
      );
  ...
  const handleBackofficeSave = async () => {
    ...
    await Promise.all(
      sectionsToSave.map(async (sectionKey) => {
        ...
        await axios.post(
          `http://localhost:5000/api/tableaux/backoffice/${victime._id}`,
