...
export default function FormServiceAT() {
  ...
  useEffect(() => {
    const url = formData.societe 
      ? `https://assu1-production.up.railway.app/api/rapport-medecin?societe=${formData.societe}&role=service-at`
      : `https://assu1-production.up.railway.app/api/rapport-medecin?role=service-at`;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const resDeclaration = await axios.post(
        "https://assu1-production.up.railway.app/api/declaration-at/create",
        formData
      );
